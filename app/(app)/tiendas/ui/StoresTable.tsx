                ...
                onClick: async () => {
                    ...
                    try {
                        ...
                        if (result.ok) {
                            ...
                            toast.error(result.message || 'No se pudo eliminar la tienda');
                        }
                    } catch {
                        toast.error('Error inesperado al eliminar la tienda');
                    } finally {
                        setIsDeleting(null);
                    }
                },
                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                        <div className="max-w-2xl space-y-3">
                            ...
                            <p className="text-sm leading-6 text-slate-600 sm:text-base">
                                Administra, busca y edita las sucursales del sistema.
                            </p>
                        </div>
                                        ...
                                        data.map((store) => (
                                            <tr key={store.id} className="transition hover:bg-slate-50">
                                                ...
                                                <td className="px-5 py-4 text-sm text-slate-500">
                                                    <span className="block max-w-[16rem] truncate">{store.id}</span>
                                                </td>
                                                <td className="px-5 py-4">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        >
                                                            ...
                                                            {isDeleting === store.id ? 'Eliminando...' : 'Eliminar'}
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
